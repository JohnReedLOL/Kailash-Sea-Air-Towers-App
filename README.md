...
This project has been significantly refactored to meet modern standards:
- **Async/Await Refactoring**: Completely removed legacy "Callback Hell" patterns. All database operations and middleware now use modern `async/await` syntax for better readability and error handling.
- **Dependency Upgrades**: All core packages (Express, Mongoose, Passport, etc.) have been updated to their latest stable/LTS versions to ensure security and performance.
- **Security Fixes**: Removed deprecated and vulnerable libraries like `fbgraph`.
- **Node.js 24+ Support**: Optimized for the latest Node.js environments.
## Support & Maintenance
If you have any questions regarding the refactoring or need further assistance with deployment:
- **Developer**: Davyd.Kaulko
- **GitHub**: https://github.com/davydkaulko

## Quick Start
1. **Install Dependencies**: 
To install or update these dependencies you can use `npm install` or `npm update`.
2. **Setup Environment**: 
   create new .env file then copy `.env.example` to `.env` and complete using your MongoDB URI.
3. **Build the Project**: 
   `npm run build`
4. **Run the App**: 
   `npm start`
